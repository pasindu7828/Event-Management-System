...
const LoginView = ({
    ...
    <div className="min-h-screen w-full bg-[#0a0a1a] flex font-sans overflow-hidden relative selection:bg-blue-100 selection:text-blue-900 animate-fade-in">
        ...
        <div className="absolute inset-0 z-[2] pointer-events-none overflow-hidden">
            <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-blue-500/20 rounded-full blur-[120px] animate-pulse"></div>
            <div className="absolute bottom-[-10%] right-[20%] w-[400px] h-[400px] bg-indigo-500/15 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }}></div>
            {[...Array(25)].map((_, i) => (
            ...
            <header className="w-full flex items-center justify-between px-10 lg:px-16 pt-8 pb-4">
                ...
                <div className="flex items-center gap-3 group cursor-default">
                    <div className="relative w-12 h-12 flex items-center justify-center">
                        ...
                        <div className="relative w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg transform group-hover:rotate-[12deg] transition-transform duration-500">
